...
namespace UniDI
{
    public static class Extensions
    {
        ...
        public static void Inject<C>(this GameObject injected)
        {
            ...
            {
                throw new UniDIException($"GameObject {injected.name} does not contain component of type {typeof(C).Name} to injection.");
            }
            component.Inject();
        }
        ...
        private static void ResolveComponent<C>(GameObject obj) where C : class
        {
            ...
            {
                throw new UniDIException($"GameObject {obj.name} does not contain component of type {typeof(C).Name} to resolving.");
            }
            component.Resolve();
        }
    }
